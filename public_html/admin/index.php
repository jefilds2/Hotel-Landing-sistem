  ...
  <main class="admin-page">
    ...
    <nav class="filtros">
      <?php foreach ($statusValidos as $status): ?>
        ...
        ?>
        <a class="filtro-link <?= e($classeAtivo) ?>" href="/admin/index.php?status=<?= e($status) ?>">
          <?= e($rotulo) ?>
        </a>
      <?php endforeach; ?>
    </nav>
    ...
    <section class="quartos-grid">
      <?php foreach ($quartos as $quarto): ?>
        <a class="quarto-card quarto-status-<?= e($quarto['status_exibicao']) ?>" href="/admin/quarto.php?id=<?= e((string)$quarto['id']) ?>">
