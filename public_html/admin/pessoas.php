...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        if ($acao === 'criar_pessoa') {
            ...
            redirecionar('/admin/pessoas.php?editar=' . $id);
        }
        ...
        if ($acao === 'editar_pessoa') {
            ...
            redirecionar('/admin/pessoas.php?editar=' . $pessoaId);
        }
        ...
        if ($acao === 'excluir_pessoa') {
            ...
            redirecionar('/admin/pessoas.php');
        }
    ...
    <?php if ($pessoaEdicao): ?>
      <section class="card">
        ...
        <div style="margin-top:10px;">
          <a class="btn btn-success" href="/admin/pessoa_imprimir.php?id=<?= e((string)$pessoaEdicao['id']) ?>" target="_blank" rel="noopener noreferrer">
            Imprimir ficha
          </a>
        </div>
            ...
            <tr>
              ...
              <td>
                <div style="display:flex; gap:8px; flex-wrap:wrap;">
                  <a class="btn btn-neutral" href="/admin/pessoas.php?editar=<?= e((string)$pessoa['id']) ?>">Editar / Histórico</a>
                  <a class="btn btn-success" href="/admin/pessoa_imprimir.php?id=<?= e((string)$pessoa['id']) ?>" target="_blank" rel="noopener noreferrer">Imprimir ficha</a>
